      ...
      *> HAGO UNA RECOPILACIÓN DE LA INFORMACION QUE ENCONTRE EN INTERNET
      *> LA CORRECCION PARA LOS PROFESORES ES QUE HAY MUCHOS CONCEPTOS
      *> DENTRO DE ESTO QUE NO VIMOS EN CLASE OSEA TUVE QUE BUSCARLO EN INTERNET
      *> Y SI LO VIMOS NO LLEGAMOS A ENTENDERLO Y LA INFO DE LOS PDF ES CONFUSA
      *> PORQUE NO TENEMOS UNA GUIA DE LA CLASE DICIENDO ACA VIMOS ESTE TEMA
      *> CON FLOGORITH SI SE DIO CORRECTAMENTE ESO, PERO CUANDO PASAMAOS
      *> A COBOL YA LOS CONCEPTOS NO LOS VIMOS DE LA MISMA MANERA

      *> OSEA NECESITAMOS PEQUEÑOS EJERCICIOS CON CADA TEMA ESPECIFICO
      *> PARA ENTENDER COMO FUNCIONA CADA COSA SIN TENER QUE MIRAR
      *> COMPLEJOS CODIGOS QUE ESTRESAN Y GENERAN CONFUSION.
      *> TAMBIEN ES MUY IMPORTANTE PODER PROBARLO, YA QUE SINO, NO SABEMOS
